...
const Page: React.FC = () => {
    return (
        <main className='bg-yellow-50 w-screen h-screen flex flex-col items-center justify-center'>
            ...
            <div className='border border-yellow-700 rounded-lg bg-white shadow-lg p-10'>
